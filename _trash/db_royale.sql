...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-12-2018 a las 10:53:02
...
(48, 23, 30, '10.00', 1, '10.00', ''),
(52, 25, 17, '9.00', 1, '9.00', 'CON ENSALADA DOBLE'),
(55, 26, 44, '3.00', 4, '12.00', ''),
(57, 26, 33, '3.00', 1, '3.00', ''),
(59, 26, 35, '4.00', 2, '8.00', ''),
(61, 27, 16, '8.00', 1, '8.00', ''),
(66, 24, 32, '3.00', 4, '12.00', ''),
(67, 24, 21, '5.90', 1, '5.90', ''),
(68, 24, 29, '10.00', 2, '20.00', 'bien heladas');
...
(23, '2018-11-03', '16.00', 'presencial', 'Mesa 04', 'pendiente'),
(24, '2018-11-04', '37.90', 'presencial', 'Mesa 01', 'pendiente'),
(25, '2018-11-05', '12.00', 'presencial', 'Mesa 03', 'pendiente'),
(26, '2018-11-05', '23.00', 'presencial', 'Mesa 03', 'pendiente'),
(27, '2018-11-05', '48.20', 'presencial', 'Mesa 04', 'finalizado');
...
(3, 'Andres', 'Cordova', '947854125', 'cord@gmail.com', 'andru', 'ba5bfc9d29e57bda5c45cf82d9fff043329f313a', 1, 1);
...
(21, 27, 1, 1, '2018-11-06', 0, '0.00', '48.20', 2, '000037', '1', '90.00', '41.80');
...
--
ALTER TABLE `detalle_pedido`
  MODIFY `dp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
...
--
ALTER TABLE `pedido`
  MODIFY `ped_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
